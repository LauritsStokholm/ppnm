...
#include <stdlib.h>
#include <time.h>
#include <float.h> // for the machine delta
#include <math.h>
#include <assert.h>
...
void    vector_scale      (double a, vector* v);
...
int qnewton
  (
    ...
    vector* x,                          // Initial guess; on return minimum
    void* params,                       // Parameters for function
    double eps                          // on return should |grad| < eps
  );
