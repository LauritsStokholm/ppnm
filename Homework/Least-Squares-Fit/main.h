...
typedef struct {int size; double (*function)(int, double);
                vector* coefficients; matrix* covariance;} funlst;
//funlst* funlst_alloc (int n);
//void funlst_free (funlst* F);
//void funlst_set (funlst* F, int i, double (*f)(double));
