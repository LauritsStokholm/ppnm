...
komplex komplex_sub_alternative      (komplex a, komplex b); /* returns a-b */

///* the following is optional */
int     komplex_equal    (komplex a, komplex b, double abs_eps, double rel_eps); /* returns 1 if equal, 0 otherwise */
